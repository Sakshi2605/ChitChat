...
public class GroupChatActivity extends AppCompatActivity
{
    ...
    private void InitializeFields()
    {
        ...
        userMessageInput = (EditText) findViewById(R.id.input_group_messaage);
    ...
    private void SaveMessagToDatabase()
    {
        ...
        {
            Toast.makeText(this, "Write a message", Toast.LENGTH_SHORT);
        }
        else
        {
            Calendar calForDate =  Calendar.getInstance();
            SimpleDateFormat curDateFormat = new SimpleDateFormat("MMM dd, yyyy");
            currentDate = curDateFormat.format(calForDate.getTime());

            Calendar calForTime =  Calendar.getInstance();
            SimpleDateFormat curTimeFormat = new SimpleDateFormat("hh:mm a");
            currentTime = curTimeFormat.format(calForTime.getTime());
